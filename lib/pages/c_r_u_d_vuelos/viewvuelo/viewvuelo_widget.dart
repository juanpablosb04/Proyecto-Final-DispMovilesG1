...
import 'viewvuelo_model.dart';
export 'viewvuelo_model.dart';

class ViewvueloWidget extends StatefulWidget {
  const ViewvueloWidget({super.key});

  @override
  State<ViewvueloWidget> createState() => _ViewvueloWidgetState();
}

class _ViewvueloWidgetState extends State<ViewvueloWidget> {
  late ViewvueloModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewvueloModel());
  }
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  'EditVuelos',
                                  queryParameters: {
                                    'skuVuelo': serializeParam(
                                      listViewVuelosRecord,
                                      ParamType.Document,
                                    ),
                                  }.withoutNulls,
                                  extra: <String, dynamic>{
                                    'skuVuelo': listViewVuelosRecord,
                                  },
                                );
                              },
                              child: Container(
